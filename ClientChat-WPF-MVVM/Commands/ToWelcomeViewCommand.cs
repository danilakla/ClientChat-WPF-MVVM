...
{
    private readonly WelcomeChatViewModel _welcomeChatViewModel;
    ...
    public ToWelcomeViewCommand(WelcomeChatViewModel welcomeChatViewModel, ChatNavigationViewModel chatNavigationViewModel)
    {
